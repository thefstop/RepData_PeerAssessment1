...
```
3.The mean number of steps taken per day is `r meanSteps`. The median number of steps taken per day is `r medianSteps` steps 
...
```
2. The 5-minute inverval with the most steps is `r mostSteps`  
...
```
1. The total number of missing data is `r totalMissing`
